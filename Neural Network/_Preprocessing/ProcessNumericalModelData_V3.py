...
rootPath = 'E:\\Numerical Model v4\\Outputs\\_For Processing'

varPaths = [f.path for f in os.scandir(rootPath) if f.is_dir()] # Dataset Folders

# Find all configuration directories for each Dataset
