...
configFile = 'Config/ModelConfigurations.xls';
matFile = 'Config/MaterialParameters.xls';
settingsFile = 'Config/Settings.xls';
...
disp(sprintf("Total Configs: %d",totalConfigs));
